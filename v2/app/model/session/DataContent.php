...
class DataContent {
    ...
    function toJson(){
        ...
        foreach($this->albaranes as $albar){
            $aux = [];
            $aux["cod_albaran"] = $albar->getCodAlbaran();
            $aux["cod_cliente"] = $albar->getCodCliente();
            $aux["nombre_cliente"] = $albar->getNombreCliente();
            $aux["fecha"] = $albar->getFecha();
            $aux["estado"] = $albar->getEstado();
            $aux["lineas"] = $albar->getLineas();
