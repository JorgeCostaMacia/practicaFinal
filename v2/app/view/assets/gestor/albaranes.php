            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <form id="formSearch" class="col-lg-4 col-md-4 col-sm-12 col-xs-12 navbar-right text-center">
                    ...
                    <select name="campSearch" class="form-control">
                        ...
                        <option value="lineas_albaranes.cod_pedido">Codigo pedido</option>
                    ...
                    <br>
                    <button type="button" id="carrito" name="carrito" class="form-control btn-warning" value=""><span class="icon glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Carrito procesar</button>
                    <button type="button" id="reiniciar" name="reiniciar" class="form-control btn-danger" value=""><span class="icon glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Borrar</button>
                    <ul class="pagination">
