                ...
                <div class="container panelHome">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="butGrup col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <a href="../solicitudes/" class="btnHome btn btn-primary btn-lg col-lg-3 col-md-3 col-sm-6 col-xs-12" role="button"><span class="glyphicon glyphicon-cog"></span><br/>Solicitudes</a>
                                <a href="../clientes/" class="btnHome btn btn-primary btn-lg col-lg-3 col-md-3 col-sm-6 col-xs-12" role="button"><span class="glyphicon glyphicon-cog"></span> <br/>Clientes</a>
                                <a href="../gestores/" class="btnHome btn btn-primary btn-lg col-lg-3 col-md-3 col-sm-6 col-xs-12" role="button"><span class="glyphicon glyphicon-cog"></span><br/>Gestores</a>
                                <a href="../articulos/" class="btnHome btn btn-primary btn-lg col-lg-3 col-md-3 col-sm-6 col-xs-12" role="button"><span class="glyphicon glyphicon-cog"></span> <br/>Articulos</a>
                            </div>
                            <div class="butGrup col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <a href="../accesos/" class="btnHome btn btn-primary btn-lg col-lg-3 col-md-3 col-sm-6 col-xs-12" role="button"><span class="glyphicon glyphicon-list-alt"></span><br/>Accesos</a>
                                <a href="../actividad/" class="btnHome btn btn-primary btn-lg col-lg-3 col-md-3 col-sm-6 col-xs-12" role="button"><span class="glyphicon glyphicon-list-alt"></span> <br/>Actividad</a>
                            </div>
                        </div>
                    </div>
                </div>
