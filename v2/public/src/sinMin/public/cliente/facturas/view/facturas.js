...
function injectLineas(facturas){
    let tableLineas = '<form id="formLineas" name="formLineas">' +
        '<h2>Factura ' + facturas[0]["cod_factura"] +'</h2>' +
    ...
    for(let i = 0; i < facturas.length; i++){
        tableLineas +=
            '<tr><td>' + facturas[i]["cod_linea"] + '</td>' +
            '<td>' + facturas[i]["cod_articulo"] + '-' + facturas[i]["nombre_articulo"] + '</td>' +
            '<td>' + ("" + ((1 * facturas[i]['precio']).toFixed(2))).replace(".", ",")+ '</td>' +
            '<td>' + facturas[i]["descuento"].replace(".", ",") + '</td>' +
            '<td>' + facturas[i]["iva"].replace(".", ",") + '</td>' +
            '<td>' + ("" + ((1 * facturas[i]['total']).toFixed(2))).replace(".", ",")+ '</td>' +
            '<td>' + facturas[i]["estado"] + '</td>' +
            '<td>' + facturas[i]["cantidad"] + '</td></tr>';
    }
